...
public class CurrencyService {
    ...
    private final String baseUrl = "https://api.freecurrencyapi.com";
    ...
    public Map<String, Object> getExchangeRate(String currencyWanted) {
        ...
        return webClient.get()
                        .uri(uriBuilder -> uriBuilder.path("/v1/latest")
                                        .queryParam("apikey", "fca_live_NHtYynIhnS7wMEhNIjiCsQHI6xzux5gg3cBADmLJ") // Consider moving API keys to configuration
    ...
    public Map<String, Object> getAllCurrencies() {
        ...
        return webClient.get()
                        .uri(uriBuilder -> uriBuilder.path("/v1/currencies")
                                        .queryParam("apikey", "fca_live_NHtYynIhnS7wMEhNIjiCsQHI6xzux5gg3cBADmLJ") // Move API keys to configuration
                                        .build())
                        .retrieve()
                        .bodyToMono(new ParameterizedTypeReference<Map<String, Object>>() {})
                        .block();
